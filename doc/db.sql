...
`secret_access_key` VARCHAR(128) COMMENT "secret_access_key",
`app_name` VARCHAR(64) DEFAULT 'QB' COMMENT "APP_NAME",
`app_version` varchar(10) DEFAULT '1.0.0' COMMENT "APP_VERSION",
`MWS_AUTH_TOKEN` VARCHAR(64) COMMENT "MWS_AUTH_TOKEN",
`marketplace_id_ca` VARCHAR(64) COMMENT "MARKETPLACE_ID_CA",
`marketplace_id_us` VARCHAR(64) COMMENT "MARKETPLACE_ID_US",
`merchant_id_ca` VARCHAR(64) COMMENT "MERCHANT_ID_CA",
`maerchant_id_com` VARCHAR(64) COMMENT "MERCHANT_ID_COM",
`maerchant_id_com_mx` VARCHAR(64) COMMENT "MERCHANT_ID_COM_MX",
