 ...
 *
 *
 * MarketplaceWebServiceClient is implementation of MarketplaceWebService based
 * on the Apache
...
public class MarketplaceWebServiceClient implements MarketplaceWebService {
	...
	/**
	 * Constructs MarketplaceWebServiceClient with AWS Access Key ID and AWS
	 * Secret Key
	 *
	...
	/**
	 * Constructs MarketplaceWebServiceClient with AWS Access Key ID, AWS Secret
	 * Key and max number of threads to spawn for async operations
	 *
	 * @param awsAccessKeyId
	 *            AWS Access Key ID
	 * @param awsSecretAccessKey
	 ...
	 */
	public MarketplaceWebServiceClient(String awsAccessKeyId, String awsSecretAccessKey, String applicationName,
			String applicationVersion, int maxAsyncThreads) {
		this(awsAccessKeyId, awsSecretAccessKey, applicationName, applicationVersion,
	...
	/**
	 * Constructs MarketplaceWebServiceClient with AWS Access Key ID, AWS Secret
	 * Key and MarketplaceWebServiceConfig. Use MarketplaceWebServiceConfig to
	 * pass additional configuration that affects how service is being called.
	 *
	 * @param awsAccessKeyId
	 *            AWS Access Key ID
	 * @param awsSecretAccessKey
	 ...
	 * Get Report
	 *
	 * The GetReport operation returns the contents of a report. Reports can
	 * potentially be very large (>100MB) which is why we only return one report
	 * at a time, and in a streaming fashion.
	 * 
	 * @param request
	 *            GetReportRequest request
	 * @return GetReport Response from the service
	 *
	 ...
	 * <p/>
	 * If service error has occured, MarketplaceWebServiceException can be
	 ...
	 * @param request
	 *            GetReportRequest request
	 * @return Future&lt;GetReportResponse&gt; future pointer to
	 *         GetReportResponse
	 * 
	 */
	 ...
	 * @return GetReportScheduleCount Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * @param request
	 *            GetReportScheduleCountRequest request
	 * @return Future&lt;GetReportScheduleCountResponse&gt; future pointer to
	 *         GetReportScheduleCountResponse
	 * 
	 */
	public Future<GetReportScheduleCountResponse> getReportScheduleCountAsync(
			final GetReportScheduleCountRequest request) {
		Future<GetReportScheduleCountResponse> response = asyncExecutor
				.submit(new Callable<GetReportScheduleCountResponse>() {
	 ...
	 *
	 * retrieve the next batch of list items and if there are more items to
	 * retrieve
	 * 
	 * @param request
	 *            GetReportRequestListByNextTokenRequest request
	 * @return GetReportRequestListByNextToken Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * <p/>
	 * Returns <code>future</code> pointer to
	 ...
	 * @param request
	 *            GetReportRequestListByNextTokenRequest request
	 * @return Future&lt;GetReportRequestListByNextTokenResponse&gt; future
	...
	public Future<GetReportRequestListByNextTokenResponse> getReportRequestListByNextTokenAsync(
			final GetReportRequestListByNextTokenRequest request) {
		Future<GetReportRequestListByNextTokenResponse> response = asyncExecutor
				.submit(new Callable<GetReportRequestListByNextTokenResponse>() {
	 ...
	 *
	 * The UpdateReportAcknowledgements operation updates the acknowledged
	 * status of one or more reports.
	 * 
	 * @param request
	 *            UpdateReportAcknowledgementsRequest request
	 * @return UpdateReportAcknowledgements Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	public UpdateReportAcknowledgementsResponse updateReportAcknowledgements(
			UpdateReportAcknowledgementsRequest request) throws MarketplaceWebServiceException {
	 ...
	 * @param request
	 *            UpdateReportAcknowledgementsRequest request
	 * @return Future&lt;UpdateReportAcknowledgementsResponse&gt; future pointer
	 *         to UpdateReportAcknowledgementsResponse
	 * 
	 */
	public Future<UpdateReportAcknowledgementsResponse> updateReportAcknowledgementsAsync(
			final UpdateReportAcknowledgementsRequest request) {
		Future<UpdateReportAcknowledgementsResponse> response = asyncExecutor
				.submit(new Callable<UpdateReportAcknowledgementsResponse>() {
	 ...
	 * Submit Feed
	 *
	 * Uploads a file for processing together with the necessary metadata to
	 * process the file, such as which type of feed it is. PurgeAndReplace if
	 * true means that your existing e.g. inventory is wiped out and replace
	 * with the contents of this feed - use with caution (the default is false).
	 * 
	 * @param request
	 *            SubmitFeedRequest request
	 * @return SubmitFeed Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * @param request
	 *            SubmitFeedRequest request
	 * @return Future&lt;SubmitFeedResponse&gt; future pointer to
	 *         SubmitFeedResponse
	 * 
	 */
	 ...
	 * PurgeAndReplace if true means that your existing e.g. inventory is wiped
	 * out and replace with the contents of this feed - use with caution (the
	 * default is false).
	 * 
	 * This function assumes the Content MD5 value is unset in the request, and
	 * will set it before making the Submit Feed request. The Feed Content must
	 * be stored on disk, as the assumption is that the content is accessed
	 ...
	 * Get Report Count
	 *
	 * returns a count of reports matching your criteria; by default, the number
	 * of reports generated in the last 90 days, regardless of acknowledgment
	 * status
	 * 
	 * @param request
	 *            GetReportCountRequest request
	 * @return GetReportCount Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * @param request
	 *            GetReportCountRequest request
	 * @return Future&lt;GetReportCountResponse&gt; future pointer to
	 *         GetReportCountResponse
	 * 
	 */
	 ...
	 * @return GetFeedSubmissionListByNextToken Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * @param request
	 *            GetFeedSubmissionListByNextTokenRequest request
	 * @return Future&lt;GetFeedSubmissionListByNextTokenResponse&gt; future
	...
	public Future<GetFeedSubmissionListByNextTokenResponse> getFeedSubmissionListByNextTokenAsync(
			final GetFeedSubmissionListByNextTokenRequest request) {
		Future<GetFeedSubmissionListByNextTokenResponse> response = asyncExecutor
				.submit(new Callable<GetFeedSubmissionListByNextTokenResponse>() {
	 ...
	 *
	 * cancels feed submissions - by default all of the submissions of the last
	 * 30 days that have not started processing
	 * 
	 * @param request
	 *            CancelFeedSubmissionsRequest request
	 * @return CancelFeedSubmissions Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * @param request
	 *            CancelFeedSubmissionsRequest request
	 * @return Future&lt;CancelFeedSubmissionsResponse&gt; future pointer to
	 *         CancelFeedSubmissionsResponse
	 * 
	 */
	public Future<CancelFeedSubmissionsResponse> cancelFeedSubmissionsAsync(
			final CancelFeedSubmissionsRequest request) {
		Future<CancelFeedSubmissionsResponse> response = asyncExecutor
				.submit(new Callable<CancelFeedSubmissionsResponse>() {
	 ...
	 * @return RequestReport Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * @param request
	 *            RequestReportRequest request
	 * @return Future&lt;RequestReportResponse&gt; future pointer to
	 *         RequestReportResponse
	 * 
	 */
	 ...
	 * @return GetFeedSubmissionCount Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * @param request
	 *            GetFeedSubmissionCountRequest request
	 * @return Future&lt;GetFeedSubmissionCountResponse&gt; future pointer to
	 *         GetFeedSubmissionCountResponse
	 * 
	 */
	public Future<GetFeedSubmissionCountResponse> getFeedSubmissionCountAsync(
			final GetFeedSubmissionCountRequest request) {
		Future<GetFeedSubmissionCountResponse> response = asyncExecutor
				.submit(new Callable<GetFeedSubmissionCountResponse>() {
	 ...
	 *
	 * cancels report request that have not yet started processing, by default
	 * all those within the last 90 days
	 * 
	 * @param request
	 *            CancelReportRequestsRequest request
	 * @return CancelReportRequests Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * @param request
	 *            CancelReportRequestsRequest request
	 * @return Future&lt;CancelReportRequestsResponse&gt; future pointer to
	 *         CancelReportRequestsResponse
	 * 
	 */
	public Future<CancelReportRequestsResponse> cancelReportRequestsAsync(final CancelReportRequestsRequest request) {
		Future<CancelReportRequestsResponse> response = asyncExecutor
				.submit(new Callable<CancelReportRequestsResponse>() {
	 ...
	 * @return GetReportList Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * @param request
	 *            GetReportListRequest request
	 * @return Future&lt;GetReportListResponse&gt; future pointer to
	 *         GetReportListResponse
	 * 
	 */
	 ...
	 * @return GetFeedSubmissionResult Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * @param request
	 *            GetFeedSubmissionResultRequest request
	 * @return Future&lt;GetFeedSubmissionResultResponse&gt; future pointer to
	 *         GetFeedSubmissionResultResponse
	 * 
	 */
	public Future<GetFeedSubmissionResultResponse> getFeedSubmissionResultAsync(
			final GetFeedSubmissionResultRequest request) {
		Future<GetFeedSubmissionResultResponse> response = asyncExecutor
				.submit(new Callable<GetFeedSubmissionResultResponse>() {
	 ...
	 *
	 * returns a list of feed submission identifiers and their associated
	 * metadata
	 * 
	 * @param request
	 *            GetFeedSubmissionListRequest request
	 * @return GetFeedSubmissionList Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * @param request
	 *            GetFeedSubmissionListRequest request
	 * @return Future&lt;GetFeedSubmissionListResponse&gt; future pointer to
	 *         GetFeedSubmissionListResponse
	 * 
	 */
	public Future<GetFeedSubmissionListResponse> getFeedSubmissionListAsync(
			final GetFeedSubmissionListRequest request) {
		Future<GetFeedSubmissionListResponse> response = asyncExecutor
				.submit(new Callable<GetFeedSubmissionListResponse>() {
	 ...
	 * @return GetReportRequestList Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * @param request
	 *            GetReportRequestListRequest request
	 * @return Future&lt;GetReportRequestListResponse&gt; future pointer to
	 *         GetReportRequestListResponse
	 * 
	 */
	public Future<GetReportRequestListResponse> getReportRequestListAsync(final GetReportRequestListRequest request) {
		Future<GetReportRequestListResponse> response = asyncExecutor
				.submit(new Callable<GetReportRequestListResponse>() {
	 ...
	 * @return GetReportScheduleListByNextToken Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * @param request
	 *            GetReportScheduleListByNextTokenRequest request
	 * @return Future&lt;GetReportScheduleListByNextTokenResponse&gt; future
	...
	public Future<GetReportScheduleListByNextTokenResponse> getReportScheduleListByNextTokenAsync(
			final GetReportScheduleListByNextTokenRequest request) {
		Future<GetReportScheduleListByNextTokenResponse> response = asyncExecutor
				.submit(new Callable<GetReportScheduleListByNextTokenResponse>() {
	 ...
	 * @return GetReportListByNextToken Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * @param request
	 *            GetReportListByNextTokenRequest request
	 * @return Future&lt;GetReportListByNextTokenResponse&gt; future pointer to
	 *         GetReportListByNextTokenResponse
	 * 
	 */
	public Future<GetReportListByNextTokenResponse> getReportListByNextTokenAsync(
			final GetReportListByNextTokenRequest request) {
		Future<GetReportListByNextTokenResponse> response = asyncExecutor
				.submit(new Callable<GetReportListByNextTokenResponse>() {
	 ...
	 *
	 * Creates, updates, or deletes a report schedule for a given report type,
	 * such as order reports in particular.
	 * 
	 * @param request
	 *            ManageReportScheduleRequest request
	 * @return ManageReportSchedule Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * @param request
	 *            ManageReportScheduleRequest request
	 * @return Future&lt;ManageReportScheduleResponse&gt; future pointer to
	 *         ManageReportScheduleResponse
	 * 
	 */
	public Future<ManageReportScheduleResponse> manageReportScheduleAsync(final ManageReportScheduleRequest request) {
		Future<ManageReportScheduleResponse> response = asyncExecutor
				.submit(new Callable<ManageReportScheduleResponse>() {
	 ...
	 *
	 * returns a count of report requests; by default all the report requests in
	 * the last 90 days
	 * 
	 * @param request
	 *            GetReportRequestCountRequest request
	 * @return GetReportRequestCount Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * @param request
	 *            GetReportRequestCountRequest request
	 * @return Future&lt;GetReportRequestCountResponse&gt; future pointer to
	 *         GetReportRequestCountResponse
	 * 
	 */
	public Future<GetReportRequestCountResponse> getReportRequestCountAsync(
			final GetReportRequestCountRequest request) {
		Future<GetReportRequestCountResponse> response = asyncExecutor
				.submit(new Callable<GetReportRequestCountResponse>() {
	 ...
	 * @return GetReportScheduleList Response from the service
	 *
	 * @throws MarketplaceWebServiceException
	 */
	 ...
	 * @param request
	 *            GetReportScheduleListRequest request
	 * @return Future&lt;GetReportScheduleListResponse&gt; future pointer to
	 *         GetReportScheduleListResponse
	 * 
	 */
	public Future<GetReportScheduleListResponse> getReportScheduleListAsync(
			final GetReportScheduleListRequest request) {
		Future<GetReportScheduleListResponse> response = asyncExecutor
				.submit(new Callable<GetReportScheduleListResponse>() {
	...
	private String getSubmitFeedUrlParameters(Map<String, String> parameters)
			throws SignatureException, MarketplaceWebServiceException {
	...
	private <T, U> T invoke(Class<T> clazz, Map<String, String> parameters, U request)
		...
		try {
			...
			// SubmitFeed will be the only MWS API function that will stream
			// requests to the server.
			if (request instanceof SubmitFeedRequest) {

				// For SubmitFeed, HTTP body is reserved for the Feed Content
				...
				/*
				 * Set content type and encoding - encoding and charset are
				 * ignored right now because octet-stream is the only supported
				 * transport of MWS feeds.
				 */
...
//				addRequiredParametersToRequest(method, parameters);
		...
		try {
			...
			do {
				...
				try {
					...
					// GetFeedSubmissionResult and GetReport will be the only
					// MWS API functions that will stream
					// server responses.
	...
	private ResponseHeaderMetadata getResponseHeaderMetadata(HttpResponse response) {
		...
		return new ResponseHeaderMetadata(requestId != null ? requestId.getValue() : null,
	...
	private MarketplaceWebServiceException processErrors(String responseString, int status,
		...
		if (responseString != null && responseString.startsWith("<")) {
			...
			if (matcher.matches()) {
				ex = new MarketplaceWebServiceException(matcher.group(3), status, matcher.group(2), "Unknown",
						matcher.group(1), responseString, metadata);
			} else {
				matcher = ERROR_PATTERN_TWO.matcher(responseString);
				if (matcher.matches()) {
					ex = new MarketplaceWebServiceException(matcher.group(2), status, matcher.group(1), "Unknown",
	...
	private static int extractPortNumber(String url, boolean usesHttps) {
		...
		if (portNumber == -1) {
			...
			if (usesHttps) {
				// it uses https, so we should return the standard https port
				// number
				return 443;
			} else {
				// it uses http, so we should return the standard http port
				// number
				return 80;
			}
		} else {
	 ...
	 */
	private Map<String, String> convertGetFeedSubmissionListByNextToken(
			GetFeedSubmissionListByNextTokenRequest request) {
	...
	private Map<String, String> convertGetFeedSubmissionCount(GetFeedSubmissionCountRequest request) {
		...
		if (request.isSetFeedProcessingStatusList()) {
			...
			for (String status : statusList) {
				params.put("FeedProcessingStatusList" + "." + "Status" + "." + (statusList.indexOf(status) + 1),
						status);
			}
		}
		if (request.isSetSubmittedFromDate()) {
	...
	private Map<String, String> convertCancelReportRequests(CancelReportRequestsRequest request) {
		...
		if (request.isSetReportProcessingStatusList()) {
			...
			for (String status : statusList) {
				params.put("ReportProcessingStatusList" + "." + "Status" + "." + (statusList.indexOf(status) + 1),
						status);
			}
		}
	 ...
	 */
	private Map<String, String> convertGetReportScheduleListByNextToken(
			GetReportScheduleListByNextTokenRequest request) {
